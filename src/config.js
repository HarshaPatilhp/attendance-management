...
export const CONFIG = {
  ...
  GOOGLE_SCRIPT_URL: 'https://script.google.com/macros/s/AKfycbw_-mPyyz-ImXSY6-yIaRhoAnOejgc0LS9nD7HthfPNldGBcn36sPBtT2Jb8EiU3Feh/exec', // ← This needs to be the Apps Script DEPLOYMENT URL (not Sheets URL)
