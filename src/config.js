...
export const CONFIG = {
  ...
  GOOGLE_SCRIPT_URL: 'https://script.google.com/macros/s/AKfycbx5jcY59hUbfKsUd7nmWp5vvmlNV26CNzKDO09D0msx5eXRJ4jv9IjpGwHcF8iIBNpe/exec', // ← This needs to be the Apps Script DEPLOYMENT URL (not Sheets URL)
